...
abstract class VendingMachine {
    ...
    */
    protected void testVendingMachine(Main main){
        ...
        testPanel.setLayout(new GridLayout(0, 1, 10, 10));
        ...
        testPanel.add(vmFeatureButton);
        testPanel.add(mFeatureButton);
        testPanel.add(main.goToMainMenu(main));
    ...
    */
    ...
    protected void collectMoney(Main main) {
        ...
        collectPanel.add(doneButton);
        main.mainFrame.add(collectPanel);
        main.mainFrame.revalidate();
        main.mainFrame.repaint();
    }
    ...
    */
    ...
    protected void replenishChange(Main main){
        ...
        repButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e){
                ...
                if(temp>0){
                    ...
                    repLabel = new JLabel("Invalid Money");
                    repPanel = new JPanel();
                    repPanel.add(repLabel);
                    repPanel.setPreferredSize(new Dimension(220, 30));
                }
        ...
        main.mainFrame.add(repPanel);
        repPanel.add(doneButton);
        main.mainFrame.revalidate();
        main.mainFrame.repaint();
    ...
    */
    ...
    protected void printTransactionSummary(Main main){
        ...
        titlePanel.setPreferredSize(new Dimension(700, 500));
        titlePanel.add(printLabel);
    ...
    */
    ...
    protected void calculate(Main main, double price){
        ...
        calcuPanel.setLayout(new GridLayout(0, 1));
        ...
        calcuPanel.add(calcuLabel);
        calcuPanel.setPreferredSize(new Dimension(500, 400));
        ...
        calcuPanel.add(payButton);
        calcuPanel.add(cancelButton);
