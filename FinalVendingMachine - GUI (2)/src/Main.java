...
public class Main {
    ...
    protected VendingMachine vm, chosenVM;
    public int selected;
    private Scanner scn;
    ...
    public void createMenu(Main main) {
        ...
        createPanel.setLayout(new GridLayout(0, 1, 10, 10));
        createPanel.add(creatLabel);
        
        createPanel.add(regButton);
        createPanel.add(specButton);
        createPanel.add(goToMainMenu(main));
    ...
    public void testMenu(Main main) {
            ...
            public void actionPerformed(ActionEvent e) {
                if(vms.size()>1) {
                    for(int i = 0 ; i<vms.size(); i++){
                        JButton vmButton = new JButton(vms.get(i).name);
                        chosenVM = vms.get(i);
                        vmButton.addActionListener(new ActionListener() {
                            @Override
                            public void actionPerformed(ActionEvent e){
                                chosenVM.testVendingMachine(main);
                            }
                        });
        ...
        testPanel.add(currentButton);
        testPanel.add(anotherButton);
        testPanel.add(goToMainMenu(main));
