...
public class SpecialItem {
    ...
    protected List<Item> chocolates = new ArrayList<>();
    protected List<Item> flavors = new ArrayList<>();

    public SpecialItem(String itemName, int quantity, int cups, int noFlavors, int noChocolates) {
    ...
    public void setChocolates(List<Item> chocolates){
