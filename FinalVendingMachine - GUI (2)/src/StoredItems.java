...
public class StoredItems {
    ...
    */
    ...
    public void displayItemsButton(Main main, JDialog chooseDialog, List<Item> vmItem, int slot, int quantity, List<Item> itemList, int itemNum) {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            if(temp==0 ){
                                if(itemNo<slot){
                                    ...
                                    JLabel messLabel = new JLabel("Slot is full");
                                ...
                                if(!(quantity <= vmItem.size())){
                                    JDialog warningDialog = new JDialog(chooseDialog, "Warning");
                                    JLabel messLabel = new JLabel("Doesn't have enough stock");
                                    JPanel warnPanel = new JPanel();
                                    warnPanel.add(messLabel);
                                    warnPanel.setPreferredSize(new Dimension(220, 30));
                                    warningDialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
